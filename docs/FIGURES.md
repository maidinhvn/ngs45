...
The eight-stage ngs45 workflow (S0/S6 optional), drawn in the same Graphviz style
as easy45 for consistency. Source: [`pipeline.dot`](pipeline.dot) →
`dot -Tpng -Gdpi=300 pipeline.dot`; vector at [`pipeline.svg`](pipeline.svg).
